...
class BasicDownBlock(BasicBlock):
...
if __name__ == "__main__":
    ...
    network = BasicBlock(in_channels=12, out_channels=12, do_res=True, grn=True, norm_type='group').cuda()
